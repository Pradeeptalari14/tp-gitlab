# 🔧 Troubleshooting Guide — GitLab CI/CD Pipeline Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-gitlab/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/gitlab/)
