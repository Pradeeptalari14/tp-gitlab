...
Thank you for your interest in improving the **GitLab CI/CD Pipeline Studio** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-gitlab.git
...
Generated configurations come from the **[GitLab CI/CD Pipeline Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/gitlab/)**.
